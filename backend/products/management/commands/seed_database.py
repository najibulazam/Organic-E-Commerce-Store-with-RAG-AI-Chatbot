...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        products_data = [
            # Fruits
            {'name': 'Organic Apples', 'slug': 'organic-apples', 'category': 'fruits', 'price': 4.99, 'stock': 100, 'description': 'Fresh crispy organic apples, perfect for snacking', 'is_featured': True, 'rating': 4.8, 'image': 'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=400'},
            ...
            {'name': 'Organic Strawberries', 'slug': 'organic-strawberries', 'category': 'fruits', 'price': 6.99, 'stock': 50, 'description': 'Sweet organic strawberries, farm fresh', 'is_featured': True, 'rating': 4.9, 'image': 'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?w=400'},
            ...
            {'name': 'Organic Avocados', 'slug': 'organic-avocados', 'category': 'fruits', 'price': 7.99, 'stock': 70, 'description': 'Creamy organic avocados, high in healthy fats', 'is_featured': True, 'rating': 4.7, 'image': 'https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?w=400'},
            ...
            {'name': 'Organic Tomatoes', 'slug': 'organic-tomatoes', 'category': 'vegetables', 'price': 4.99, 'stock': 90, 'description': 'Fresh organic tomatoes, vine-ripened', 'is_featured': True, 'rating': 4.6, 'image': 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=400'},
            ...
            {'name': 'Organic Cheese', 'slug': 'organic-cheese', 'category': 'dairy', 'price': 7.99, 'stock': 40, 'description': 'Artisan organic cheese, aged to perfection', 'is_featured': True, 'rating': 4.9, 'image': 'https://images.unsplash.com/photo-1452195100486-9cc805987862?w=400'},
            ...
            {'name': 'Organic Quinoa', 'slug': 'organic-quinoa', 'category': 'grains-cereals', 'price': 12.99, 'stock': 50, 'description': 'Premium organic quinoa, complete protein', 'is_featured': True, 'rating': 4.8, 'image': 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400'},
            ...
            # Nuts & Seeds
            {'name': 'Organic Almonds', 'slug': 'organic-almonds', 'category': 'nuts-seeds', 'price': 14.99, 'stock': 60, 'description': 'Raw organic almonds, vitamin E rich', 'is_featured': True, 'rating': 4.8, 'image': 'https://images.unsplash.com/photo-1508747703725-719777637510?w=400'},
            ...
            {'name': 'Organic Dark Chocolate', 'slug': 'organic-dark-chocolate', 'category': 'snacks', 'price': 9.99, 'stock': 60, 'description': '70% organic dark chocolate, antioxidant-rich', 'is_featured': True, 'rating': 4.9, 'image': 'https://images.unsplash.com/photo-1511381939415-e44015466834?w=400'},
