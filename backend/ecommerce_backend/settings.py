...
# Cloudinary Configuration - All images stored in cloud
cloudinary.config(
    cloud_name=os.getenv('CLOUDINARY_CLOUD_NAME'),
    api_key=os.getenv('CLOUDINARY_API_KEY'),
    api_secret=os.getenv('CLOUDINARY_API_SECRET'),
...
# Use Cloudinary for ALL media file storage (uploads, images, etc.)
DEFAULT_FILE_STORAGE = 'cloudinary_storage.storage.MediaCloudinaryStorage'

# Media URL - Cloudinary will override with CDN URLs
MEDIA_URL = '/media/'
